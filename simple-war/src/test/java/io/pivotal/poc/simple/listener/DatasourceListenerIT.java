...
public class DatasourceListenerIT {
	...
	public void testContextInitialized() {
		//should return the in-memory database
		listener.contextInitialized(servletContextEvent);
		//check
		Object dataSource = servletContext.getAttribute(DatasourceListener.DATASOURCE_ATTRIBUTE);
